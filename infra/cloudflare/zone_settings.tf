...
# 오리진(Traefik TLSOption default)은 T043 에서 RequireAndVerifyClientCert 로 전환(2026-09-11 M4 커밋 · 설치 시각은 런북 §3 T043) — 이 설정을 끄면
# 오리진이 edge 를 거절해 플랫폼 호스트 전부가 525 또는 520(어느 쪽인지 미실측 — 런북 VD-7)이 된다(끄지 말 것).
